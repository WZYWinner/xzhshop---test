	  ...
	  <div class="top-bar">
		...
		<div class="goods-container">
			...
			<div class="goods-right">
				...
				<div class="goods-font">套餐类型<span class="leixing">官方标配</span></div>
...
export default {
	...
	data () {
		return {
			...
			price: '3399.00',
			phoneInfo: [
				{name: '', img: require('../assets/img/whaley/1_small.jpg'), imgShow: require('../assets/img/whaley/1.jpg'), price: 3399.00}
			],
			showImg: [
				require('../assets/img/whaley/info1.jpg'),
				require('../assets/img/whaley/info2.jpg'),
				require('../assets/img/whaley/info3.jpg'),
				require('../assets/img/whaley/info4.jpg'),
				require('../assets/img/whaley/info5.jpg'),
				require('../assets/img/whaley/info6.jpg'),
				require('../assets/img/whaley/info7.jpg')
			],
			hot: [
          {
