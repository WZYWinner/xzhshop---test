...
export default {
	...
	data () {
		return {
			...
			price: '7699.00',
			phoneInfo: [
				{name: '密斯白', img: require('../assets/img/Samsung/1_small.png'), imgShow: require('../assets/img/Samsung/1.jpg'), price: 7699.00},
				{name: '麦昆黑', img: require('../assets/img/Samsung/2_small.jpg'), imgShow: require('../assets/img/Samsung/2.jpg'), price: 7899.00},
				{name: '莫奈彩', img: require('../assets/img/Samsung/3_small.jpg'), imgShow: require('../assets/img/Samsung/3.jpg'), price: 7999.00}
			],
			showImg: [
				require('../assets/img/Samsung/info1.png'),
				require('../assets/img/Samsung/info2.jpg'),
				require('../assets/img/Samsung/info3.jpg'),
				require('../assets/img/Samsung/info4.jpg'),
				require('../assets/img/Samsung/info5.jpg'),
				require('../assets/img/Samsung/info6.jpg'),
				require('../assets/img/Samsung/info7.jpg')
			],
			hot: [
          {
