...
export default {
	...
	data () {
		return {
			...
			advantage: '现货当天发顺丰+ 6期免息+延保1年',
			num: 1,
			active: false,
			price: '2699.00',
			phoneInfo: [
				{name: '绮森林', img: require('../assets/img/nova/1_small.jpg'), imgShow: require('../assets/img/nova/1.jpg'), price: 2699.00},
				{name: '珊瑚橙', img: require('../assets/img/nova/2_small.jpg'), imgShow: require('../assets/img/nova/2.jpg'), price: 2749.00},
				{name: '亮黑色', img: require('../assets/img/nova/3_small.jpg'), imgShow: require('../assets/img/nova/3.jpg'), price: 2949.00}
			],
			showImg: [
				require('../assets/img/nova/info1.jpg'),
				require('../assets/img/nova/info2.jpg'),
				require('../assets/img/nova/info3.jpg'),
				require('../assets/img/nova/info4.jpg'),
				require('../assets/img/nova/info5.jpg'),
				require('../assets/img/nova/info6.jpg'),
				require('../assets/img/nova/info7.jpg')
			],
			hot: [
          {
