		...
		<div class="goods-container">
			...
			<div class="bottom">
				...
				<div class="bottom_right">
					<div class="bottom_right_img" v-for="(item,index) in showImg" :key="index">
						<img :src="item" alt="">
					</div>
				</div>
			</div>
...
export default {
	...
	data () {
		return {
			...
			advantage: '选送AM115耳机/M3手环',
			num: 1,
			active: false,
			price: '2649.00',
			phoneInfo: [
				{name: '深空灰', img: require('../assets/img/mi/1_small.jpg'), imgShow: require('../assets/img/mi/1.jpg'), price: 2649.00},
				{name: '幻彩紫', img: require('../assets/img/mi/2_small.jpg'), imgShow: require('../assets/img/mi/2.jpg'), price: 2749.00},
				{name: '透明', img: require('../assets/img/mi/3_small.jpg'), imgShow: require('../assets/img/mi/3.jpg'), price: 2849.00}
			],
			showImg: [
				require('../assets/img/mi/info1.jpg'),
				require('../assets/img/mi/info2.jpg'),
				require('../assets/img/mi/info3.jpg'),
				require('../assets/img/mi/info4.jpg'),
				require('../assets/img/mi/info5.jpg'),
				require('../assets/img/mi/info6.jpg'),
				require('../assets/img/mi/info7.jpg')
			],
			hot: [
          {
