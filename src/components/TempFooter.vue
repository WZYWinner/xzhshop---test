    ...
    <div class="footer">
        ...
        <ul class="footer-content clearfix">
          ...
          <li class="footer-item">
            <article class="col-links">
              <h3>关注我们</h3>
              <p>官方微信</p>
              <img style="width:60px;height:60px" src="../assets/img/Wechat.jpeg" alt="">
            </article>
          </li>
          <li class="footer-last-item">
            <div class="col-content">
              <h3 class="phone-number">400032688</h3>
              <p class="phone-desc">
                周一至周日 9:00-18:00
                <br />（仅收市话费）
              </p>
      ...
      <div class="site-info">
        <div class="footer-explan clearfix">
          <img class="logo-img" src="../assets/img/kzh_logo.png" alt />
...
.footer-item a:nth-last-child(2) {
  padding-right: 20px;
  border-right: 1px solid #e0e0e0;
}
h3 {
...
.footer-desc {
  ...
  height: 19px;
  margin: 30px auto 0;
  background: url("http://s01.mifile.cn/i/slogan2016.png") center center
    no-repeat;
}
</style>
