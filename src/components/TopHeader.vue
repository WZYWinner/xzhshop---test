    ...
    return {
      ...
      tv: [
        // {name: 'HTC电视3S 43英寸', imgUrl: 'http://c1.mifile.cn/f/i/16/goods/nav/mitv3s-43!160x110.jpg', sourcePath: 'http://www.mi.com/mitv3s/43/', price: '1499元'},
        {
          ...
          sourcePath: "/goodsDetail6",
          price: "3499元起"
        },
        {
          name: "whaley/微鲸 65D2UA 65吋",
          imgUrl: require("../assets/img/whaley/1.jpg"),
          sourcePath: "/goodsDetail7",
          price: "3399元"
        }
