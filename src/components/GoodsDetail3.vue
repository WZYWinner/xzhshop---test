	  ...
	  <div class="top-bar">
		...
		<div class="goods-container">
			...
			<div class="goods-right">
				...
				<div style="color: #999;"><div class="goods-font">套餐类型:<span style="color: #280;margin-left:40px">官方标配</span></div></div>
...
export default {
	...
	data () {
		return {
			...
			isLock: false,
			jishen: 0,
			title: 'Xiaomi/小米 小米平板4 Plus平板电脑wifi安卓超薄智能大屏手机LET版',
			advantage: ' 当/次日达 下单送皮套+钢化膜',
			num: 1,
			active: false,
			price: '1849.00',
			phoneInfo: [
				{name: '白金', img: require('../assets/img/mi_pingban/1_small.png'), imgShow: require('../assets/img/mi_pingban/1.jpg'), price: 1849.00},
				{name: '墨黑', img: require('../assets/img/mi_pingban/2_small.jpg'), imgShow: require('../assets/img/mi_pingban/2.jpg'), price: 1849.00}
			],
			showImg: [
				require('../assets/img/mi_pingban/info1.jpg'),
				require('../assets/img/mi_pingban/info2.jpg'),
				require('../assets/img/mi_pingban/info3.jpg'),
				require('../assets/img/mi_pingban/info4.jpg'),
				require('../assets/img/mi_pingban/info5.jpg'),
				require('../assets/img/mi_pingban/info6.jpg'),
				require('../assets/img/mi_pingban/info7.jpg')
			],
			hot: [
          {
