	  ...
	  <div class="top-bar">
		...
		<div class="goods-container">
			...
			<div class="goods-right">
				...
				<div class="goods-font">网络类型<span class="leixing" @click="choose" :class="{goodsActive : active === true}">WLAN</span></div>
...
export default {
	...
	data () {
		return {
			jishen: 0,
			title: '三星Galaxy Tab A 2019平板电脑SM-T510 10.1英寸超薄安卓智能平板学习游戏影音 苏宁旗舰店全新',
			advantage: '30天保价 2019新款 全金属机身 轻薄便携',
			num: 1,
			active: false,
			price: '1399.00',
			phoneInfo: [
				{name: '鎏砂金', img: require('../assets/img/Samsung_pingban/1_small.png'), imgShow: require('../assets/img/Samsung_pingban/1.jpg'), price: 1399.00},
				{name: '锡墨黑', img: require('../assets/img/Samsung_pingban/2_small.jpg'), imgShow: require('../assets/img/Samsung_pingban/2.jpg'), price: 1399.00},
				{name: '铂光银', img: require('../assets/img/Samsung_pingban/3_small.jpg'), imgShow: require('../assets/img/Samsung_pingban/3.jpg'), price: 1399.00}
			],
			showImg: [
				require('../assets/img/Samsung_pingban/info1.jpg'),
				require('../assets/img/Samsung_pingban/info2.jpg'),
				require('../assets/img/Samsung_pingban/info3.jpg'),
				require('../assets/img/Samsung_pingban/info4.jpg'),
				require('../assets/img/Samsung_pingban/info5.jpg'),
				require('../assets/img/Samsung_pingban/info6.jpg'),
				require('../assets/img/Samsung_pingban/info7.jpg')
			],
			hot: [
          {
